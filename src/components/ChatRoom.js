...
import ButtonUpload from "../container/ButtonUpload";
          ...
          <div className="pageCustom">
            <div className="pageContact">
              ...
              <div className="contentContact">
                <h4 style={{  fontFamily: "arial" }}>Contact</h4>
    ...
    <div class="modal-header">
      ...
      <div className="imgProfileAccount">
                              ...
                              <Row>
                                ...
                                />
                                <ButtonUpload title="Upload" className="btnUploadImg btn-info" loadingupload={this.props.loading}  onClick={this.props.onClick} />
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title">Change Privacy</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
